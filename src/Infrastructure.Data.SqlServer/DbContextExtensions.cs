...
public static class DbContextExtensions
{
    public static async Task InitializeAsync(this DbContext context, string? targetDatabaseName = null, CancellationToken cancellationToken = default)
    {
        ...
        await context.GetService<InitializeApplicationDatabaseRequest>().InitializeAsync(connectionString: connectionString, targetDatabaseName: targetDatabaseName, cancellationToken: cancellationToken);
    }
}
