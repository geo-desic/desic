...
dotnet ef migrations add Initial --context ApplicationDbContext --project ./Infrastructure.Data.Sqlite
dotnet ef migrations add Initial --context ApplicationDbContext --project ./Infrastructure.Data.SqlServer
pause