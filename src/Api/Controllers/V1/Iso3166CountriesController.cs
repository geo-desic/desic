...
public class Iso3166CountriesController(ILogger<Iso3166CountriesController> logger, IMediator mediator) : ApiControllerBase
{
    ...
    public async Task<ActionResult<ListIso3166CountriesResult>> List([FromQuery] Pagination pagination, [FromQuery] Iso3166CountriesFilter filter, [FromQuery] Iso3166CountriesOrderingMethod orderingMethod = Iso3166CountriesOrderingMethods.Default)
    {
