...
public class EntityTypesController(ILogger<EntityTypesController> logger, IMediator mediator) : ApiControllerBase
{
    ...
    public async Task<ActionResult<ListResult<EntityType>>> List([FromQuery] Pagination pagination, [FromQuery] EntityTypesFilter filter, [FromQuery] EntityTypesOrderingMethod orderingMethod = EntityTypesOrderingMethod.NameAsc)
    {
